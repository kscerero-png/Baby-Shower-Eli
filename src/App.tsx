      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        ...
        {alerta && (
          <div className={`fixed bottom-4 right-4 z-50 p-4 rounded-2xl shadow-xl border flex items-center gap-3 animate-slide-up max-w-sm ${
            ...
            <span className="text-xl">{alerta.tipo === 'error' ? '⚠️' : '🐝'}</span>
          ...
          <div className="max-w-3xl mx-auto space-y-8">
            ...
            <div className="bg-[#FFFDF9] border border-pink-100 p-6 rounded-3xl shadow-sm">
              ...
              <p className="text-sm text-amber-950/70 mb-4">
                Pega aquí el endpoint REST de tu **Google Sheets** para que los regalos y dedicatorias se guarden automáticamente en tiempo real.
              </p>

              <div className="space-y-4">
                <div>
                  <label className="block text-xs font-bold text-amber-900/80 uppercase tracking-wider mb-1">URL / API Endpoint de Google Sheets</label>
                  <input 
                    type="text" 
